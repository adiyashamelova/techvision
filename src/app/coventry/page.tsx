...
export default function CoventryHome() {
        ...
        <section id="benefits" className="scroll-mt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <div className="bg-[#080112] border border-purple-900/30 p-6 md:p-8 rounded-[2rem] md:rounded-3xl hover:border-purple-500/50 transition-colors group">
              ...
              <p className="text-sm md:text-base text-purple-200/70 leading-relaxed">Никаких жестких кейсов. Вы сами выбираете стек, архитектуру и подход для решения актуальных проблемных зон, которые будут опубликованы на старте онлайн-этапа.</p>
            </div>
            ...
            <div className="bg-[#080112] border border-purple-900/30 p-6 md:p-8 rounded-[2rem] md:rounded-3xl hover:border-purple-500/50 transition-colors group">
              ...
              <p className="text-sm md:text-base text-purple-200/70 leading-relaxed">На оффлайн-финале вас ждут мощный нетворкинг и оценка проектов от топ-специалистов из IT-индустрии, крупного бизнеса и венчурных фондов.</p>
            </div>
